...
#### `surge`
Publish in a public url using `surge` command inside the build directory
To publish, first run `npm run build`, enter in build directory (`cd ./build`) and run `surge`.
